...
```bash
git clone https://github.com/MichaelYangzk/JobAutoApply.git
cd JobAutoApply
...
Bidirectional Email ↔ Notion sync system. Notion becomes your control terminal for tracking and triggering email actions.
...
├── main.py                       # Python — Bidirectional orchestrator
